...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:px="http://www.example.org" version="1.0" name="getMonth">
    ...
    <p:xquery name="getEv">
        <p:input port="source"/>
        <p:input port="query">
            <p:data href="xmldb:///db/apps/CalendarX/getforMonth.xquery" content-type="application/xquery"/>
        </p:input>
    </p:xquery>
    <!-- store the intermediate result to be transformed with monatssicht.xsl -->
    <p:store href="xmldb:///db/apps/CalendarX/monthEvents.xml"/>    
    ...
    <p:xslt name="transform">
        ...
        <p:input port="stylesheet">
            <p:document href="xmldb:///db/apps/CalendarX/monatssicht.xsl"/>
        </p:input>
    ...
    <p:store href="xmldb:///db/apps/CalendarX/monthEvents.html"/>
</p:declare-step>