...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc"
    ...
    <p:xquery name="getEv"> 
        <p:input port="source"/>  
        <p:input port="query">
            <p:data href="getforWeek.xquery" content-type="application/xquery"></p:data>
        </p:input>
    </p:xquery>
    <!-- store the intermediate result to be transformed with wochensicht.xsl -->
    <p:store href="weekEvents.xml"></p:store>    
    ...
    <p:xslt name="transform">
        ...
        <p:input port="stylesheet">
            <p:document href="wochensicht.xsl"/>
        </p:input>
    ...
    <p:store href="weekEvents.html"></p:store>
